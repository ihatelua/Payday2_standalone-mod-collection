...
local BuyAllAssets_localize = BuyAllAssets_localize or{
	wolfhud_buy_all_assets = "Buy All Assets",
	wolfhud_buy_all_assets_desc = "Buys all the assets that you are permitted to acquire."
}

if string.lower(RequiredScript) == "lib/managers/localizationmanager" then
	local _BuyAllAssets_localize_text = LocalizationManager.text
	
	function LocalizationManager:text(string_id, macros)
		return BuyAllAssets_localize[string_id] or _BuyAllAssets_localize_text(self, string_id, macros)
	end
